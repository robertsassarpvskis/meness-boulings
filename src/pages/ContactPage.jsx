...
const ContactPage = () => {
  ...
  return (
    ...
    />
    <div className="min-h-screen bg-[#fed273] py-12 px-4">
      {/* Header Section */}
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          {/* Map */}
          <div className="rounded-3xl overflow-hidden shadow-2xl border-2 border-[#552583]/20 h-96">
            <iframe 
          ...
          {/* Social Media */}
          <GradientCard className="p-8 rounded-3xl shadow-xl border border-[#FDB927]/10 backdrop-blur-sm bg-[#552583]/90">
            <div className="flex flex-col lg:flex-row justify-between gap-10">
              {/* Kreisa kolonna - Kontaktinformācija */}
              <div className="flex-1 space-y-6">
                <h2 className="text-2xl font-bold text-[#FDB927] tracking-wide text-center lg:text-left">
                  Sazinies ar mums
                </h2>
              ...
              <div className="flex-1 flex flex-col pt-8 lg:pt-0 border-t lg:border-t-0 lg:border-l border-[#FDB927]/20 lg:pl-10">
                ...
                <div className="flex flex-col items-center lg:items-start gap-4">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#FDB927]/20 flex items-center justify-center hover:bg-[#FDB927]/30 transition">
                        <FaFacebookF className="text-[#FDB927] text-lg group-hover:text-white" />
                      </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#FDB927]/20 flex items-center justify-center hover:bg-[#FDB927]/30 transition">
                        <FaInstagram className="text-[#FDB927] text-lg group-hover:text-white" />
                      </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#FDB927]/20 flex items-center justify-center hover:bg-[#FDB927]/30 transition">
                        <FaTiktok className="text-[#FDB927] text-lg group-hover:text-white" />
                      </div>
